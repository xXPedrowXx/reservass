...
try {
	...
	switch($event['operation']) {
		...
		case 'create':
			...
			$event_id = $capi->CreateCalendarEvent('primary', $event['title'], $event['all_day'],  $event['recurrence'], $event['recurrence_end'], $event['event_time'], $_SESSION['user_timezone'], $_SESSION['access_token'], $event['guests']);
